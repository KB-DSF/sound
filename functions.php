<?php
/**
 * sound functions and definitions
 *
 * @package sound
 */
...
if ( ! function_exists( 'sound_setup' ) ) :
/**
...
function sound_setup() {
	 ...
	 * If you're building a theme based on sound, use a find and replace
	 * to change 'sound' to the name of your theme in all the template files
	 */
 ...
 */
function sound_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'sound' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'sound_widgets_init' );
